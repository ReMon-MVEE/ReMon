...
#define IPMON_DENY_CALL_ERR(err) (16 | (err << 5)) // Do not allow the call and return -err instead
#define IPMON_DENY_CALL_VAL(val) (32 | (val << 6)) // Do not allow the call and return val instead
//#define IPMON_DENY_CALL_EXTENDED_VAL(extended_val) // Do not allow the call and return extended_val (which might be 64-bit)
...
extern long          ipmon_reg_file_map_id;
extern char*         ipmon_reg_file_map;
