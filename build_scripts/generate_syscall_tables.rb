...
File.open("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_handler_table.tmp", 'w') { |file|
...
replace_if_different("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_handler_table.h", "#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_handler_table.tmp")

print("generating MVEE_syscall_string_table.h...\n")
File.open("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_string_table.tmp", 'w') { |file|
  file.write("/* this file was generated by #{$PROGRAM_NAME} - do not edit manually */\n")
...
replace_if_different("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_string_table.h", "#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_string_table.tmp")

print("generating MVEE_syscall_alias_locks.h...\n")
File.open("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_alias_locks.tmp", 'w') { |file|
  file.write("/* this file was generated by #{$PROGRAM_NAME} - do not edit manually */\n")
...
replace_if_different("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_alias_locks.h", "#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_alias_locks.tmp")

print("generating MVEE_syscall_handler_prototypes.h...\n")
File.open("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_handler_prototypes.tmp", 'w') { |file|
  file.write("/* this file was generated by #{$PROGRAM_NAME} - do not edit manually */\n")
...
replace_if_different("#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_handler_prototypes.h", "#{@mveeroot}/MVEE/Inc/arch/#{@arch}/MVEE_syscall_handler_prototypes.tmp")

print("generating MVEE_numcalls.h...\n")
File.open("#{@mveeroot}/MVEE/Inc/MVEE_numcalls.tmp", 'w') { |file|
  file.write("/* this file was generated by #{$PROGRAM_NAME} - do not edit manually */\n")
  file.write("#define MAX_CALLS #{@numcalls}\n")
}

replace_if_different("#{@mveeroot}/MVEE/Inc/MVEE_numcalls.h", "#{@mveeroot}/MVEE/Inc/MVEE_numcalls.tmp")
