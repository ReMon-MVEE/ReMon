 ...
 *   0x30 | 0x31 | 0x32 | 0x33 | 0x34 | 0x35 | 0x36 | 0x37 |      |      | 0x3a |      | 0x3c | 0x3d | 0x3e | 0x3f |
 *        |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
 ...
 *   0x10 | 0x11 | 0x12 | 0x13 | 0x14 | 0x15 | 0x16 | 0x17 | 0x18 | 0x19 | 0x1a | 0x1b | 0x1c | 0x1d | 0x1e | 0x1f |
 *   0x20 | 0x21 | 0x22 |      | 0x24 | 0x25 | 0x26 | 0x27 | 0x28 |      | 0x2a |      | 0x2c | 0x2d | 0x2e | 0x2f |
 *   0x30 | 0x31 | 0x32 | 0x33 | 0x34 | 0x35 | 0x36 | 0x37 |      | 0x39 | 0x3a |      | 0x3c | 0x3d | 0x3e | 0x3f |
 *   0x40 | 0x41 | 0x42 | 0x43 | 0x44 | 0x45 | 0x46 | 0x47 | 0x48 | 0x49 | 0x4a | 0x4b | 0x4c | 0x4d | 0x4e | 0x4f |
 *   0x50 | 0x51 | 0x52 | 0x53 | 0x54 | 0x55 | 0x56 | 0x57 | 0x58 | 0x59 | 0x5a | 0x5b | 0x5c | 0x5d | 0x5e | 0x5f |
...
#define EXTENDED_FEATURE_EDX_BLOCKS         ~((0b1u <<   2u) |                                                         \
    ...
    static constexpr const emulation_lookup lookup_table[256] =
    {
            ...
            {&BYTE_LOADER_NAME(0x03), &BYTE_EMULATOR_NAME(0x03)},                            // 0x03
            ...
            {&BYTE_LOADER_NAME(0x23), &BYTE_EMULATOR_NAME(0x23)},                               // 0x23
            ...
            {&BYTE_LOADER_NAME(0x33), &BYTE_EMULATOR_NAME(0x33)},                                    // 0x33
            ...
            {&BYTE_LOADER_NAME(0x38), &BYTE_EMULATOR_NAME(0x38)},                               // 0x38
            {&BYTE_LOADER_NAME(0x39), &BYTE_EMULATOR_NAME(0x39)},                               // 0x39
            {&block_loader          , &block_emulator},                                              // 0x3a
            {&BYTE_LOADER_NAME(0x3b), &BYTE_EMULATOR_NAME(0x3b)},                               // 0x3b
            ...
            {&BYTE_LOADER_NAME(0x7f), &BYTE_EMULATOR_NAME(0x7f)},                               // 0x7f
            {&BYTE_LOADER_NAME(0x80), &BYTE_EMULATOR_NAME(0x80)},                               // 0x80
            {&BYTE_LOADER_NAME(0x81), &BYTE_EMULATOR_NAME(0x81)},                               // 0x81
            ...
            {&BYTE_LOADER_NAME(0x87), &BYTE_EMULATOR_NAME(0x87)},                               // 0x87
